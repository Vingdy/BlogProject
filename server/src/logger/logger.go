...
//	}
//	LogFile, err = os.OpenFile(prodir+"\\logs\\errorlog.log",
//		os.O_CREATE|os.O_WRONLY|os.O_APPEND, 0333)
//	if err != nil {
//		return fmt.Errorf("failed to open file.Errorlog: %v",err)
//	}
...
//		OutputPaths:      []string{"logs/log.log"},//记录系统日志
//		ErrorOutputPaths: []string{"logs/errorlog.log"},//记录日志系统的错误
//	}
//	//fmt.Println(prodir)
